...
| LC | @lc_fp | [GitHub](https://github.com/luochen1990/nixos-config) | 特点: 用一套命名规范区分不同类型的 nix 文件; 更新:  最新我已经将可复用部分提取出来,形成了可直接复用的单独项目: [flake-fhs](https://github.com/luochen1990/flake-fhs) |
